...
public class Functions {
    ...
    private final String[] MENU_ITEMS = {
            "Beef Ramen", "Seafood Ramen",
            "Tonkotsu Ramen", "Miso Ramen",
            "Spicy Miso Ramen", "Shoyu Ramen",
            "Wasabi Shoyu Ramen", "Pork Rice Bowl"
    };

    // upgrades
    private final String[] upgrades = {
            "Instagram Shoutout", "New Paint",
    ...
    public static void main(String[] args) {
        ...
        System.out.println(kaiw.help("!")); // prints all callable functions
        // and their descriptions
        System.out.println(kaiw.work()); // prints "You sold (random number
        // from 1 to 20) bowls
        ...
        System.out.println(kaiw.balance()); // prints You have $(balance)
        // in the bank!
        ...
        System.out.println(kaiw.rob(daniel, "testUser2")); // prints either a
        // successful robbery message or "You got caught" message

        System.out.println(kaiw.upgrades("!")); // prints all current upgrades
        // and their levels
        System.out.println(kaiw.upgrade(0)); // prints "Instagram Shoutout
        // is now level 2"
    }
}
